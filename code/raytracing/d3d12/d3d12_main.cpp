...
void GL_InitRaytracing(int width, int height) {
	common->Printf("------ GL_InitRaytracing -------\n");
	...
	m_secondHitLibrary = nv_helpers_dx12::CompileShaderLibrary(L"base/shaders/HitSecond.hlsl");
	...
	common->Printf("Loading Raytracing Shaders...\n");
	...
	common->Printf("Compiling Raytracing Pipeline...\n");
...
void GL_Init(HWND hwnd, HINSTANCE hinstance, int width, int height)
{
	...
	common->Printf("Creating D3D12 device...\n");
	...
	common->Printf("Checking for raytracing support...\n");
	...
	common->Printf("Creating GPU fences...\n");
