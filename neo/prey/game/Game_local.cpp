...
// jmarshall - moved this game code side.
	declManager->RegisterDeclType( "beam",				DECL_BEAM,			idDeclAllocator<hhDeclBeam> );
// jmarshall 
...
// jmarshall - moved this game code side.
	declManager->RegisterDeclFolder("beams",			".beam",			DECL_BEAM);
// jmarshall
...
#ifdef ID_SOUND_SPIRITWALK // jmarshall
	if (gameSoundWorld) {
		if (active) {
...
#ifdef ID_SOUND_DUCKER // jmarshall
	if (gameSoundWorld) {
